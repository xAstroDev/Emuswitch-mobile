...
async function resetBranch(execa) {
    ...
    let hasFailed = false;
    try {
        await execa("git", ["remote", "add", "source", "https://github.com/xastrodev/emuswitch-mobile.git"]);
...
async function mergebot(github, context, execa) {
    // Reset our local copy of master to what appears on xastrodev/emuswitch-mobile - master
    ...
    await fetchPullRequests(pulls, "https://github.com/xastrodev/emuswitch-mobile", execa);
